...
self.addEventListener("fetch", function (e) {
    e.respondWith((function () { return __awaiter(_this, void 0, void 0, function () {
...
self.addEventListener("activate", function (e) {
    // @ts-ignore
    e.waitUntil(caches.keys().then(function (keyList) { return Promise.all(keyList.map(function (key) {
        if (key === cacheName)
            return;
